...
$(() => {
    ...
    $(".smaily-rss-options").change(function (event) {
        ...
        var rss_limit = $('#rss #rss_product_limit').val();
        if (rss_limit != "") {
            url_parameters.limit = rss_limit;
        }

        var rss_sort_by = $('#rss #rss_sort_by').val();
        if (rss_sort_by != "") {
            url_parameters.sort_by = rss_sort_by;
        }

        var rss_sort_order = $('#rss #rss_sort_order').val();
        if (rss_sort_order != "") {
            url_parameters.sort_order = rss_sort_order;
        }

        var rss_category_id = $('#rss #rss_product_category_id').val();
        if (rss_category_id != "") {
